...
/*   Updated: 2019/04/09 19:11:29 by schebbal    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
void Bureaucrat::executeForm( Form const & src ) const
{
	...
	{
		std::cout << "<Bureaucrat " << this->_name << "> executes <" << src.getTarget() << ">." << std::endl;
		src.execute(*this);
	}
	else
...
{
    o << "<Bureaucrat " << rhs.getName() << ">, bureaucrat grade <" << rhs.getGrade() << ">" << std::endl;
    return (o);
}